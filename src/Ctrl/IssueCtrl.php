...
*/
    ...
    /**
        ...
        * 
        * Парсит http запрос и запускает соответствующий метод исходя из типа запроса
        *    
    ...
    public function processRequest()
    {
     ...
     /**
        ...
        * 
        * Запускает метод для возврата всех данных из таблицы
        *    
        * @return array 
     */
    private function getAllIssue()
    {
        ...
        * Метод обработчик для типа запроса GET
        * 
        * Запускает метод поиска по id, передаёт id 
        *
    ...
    private function getIssue($id)
    {
        ...
        * 
        *  Добавляет дату в массив с данными из запроса, запускает метод для добавляения данных в таблицу
        *
    ...
    {   $date_=date("Y-m-d H:i:s");
        ...
        * 
        * Добавляет дату в массив с данными из запроса, проверяет существование нужной записи по id, запускает метод для обновления данных 
        *
        * @var array  $input Данные из http запроса
        * @return array 
        */
    ...
    {     
        ...
        * 
        * Запускает метод для удаления записи по id
        *
        * @param int $id id записи в таблице issue
        * @return int 
        */
    private function deleteIssue($id)
    {
        ...
        * 
        * Проверяет наличие полей name и user, для метода добавления 
        *
    ...
    private function validateinsertIssue($input)
    {
      ...
      /**
        * Метод валидатор данных
        * 
        * Проверяет наличие полей user, для метода обеовления 
        *
        * @param array $input Массив поступивших данных
        * @return bool 
        */
